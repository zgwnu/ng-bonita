...
var zgwnu_bonita_user_task_1 = require("./zgwnu-bonita-user-task");
var ZgwnuBonitaUserTaskMapping = /** @class */ (function () {
    ...
    ZgwnuBonitaUserTaskMapping.prototype.mapResponse = function (res) {
        var userTaskData = new zgwnu_bonita_user_task_1.ZgwnuBonitaUserTask(res.json());
        return userTaskData;
    };
    ZgwnuBonitaUserTaskMapping.prototype.mapResponseArray = function (res) {
        ...
        for (var _i = 0, bodyArray_1 = bodyArray; _i < bodyArray_1.length; _i++) {
            ...
            userTaskDataArray.push(new zgwnu_bonita_user_task_1.ZgwnuBonitaUserTask(body));
        }
        return userTaskDataArray;
    };
    return ZgwnuBonitaUserTaskMapping;
}());
exports.ZgwnuBonitaUserTaskMapping = ZgwnuBonitaUserTaskMapping;
