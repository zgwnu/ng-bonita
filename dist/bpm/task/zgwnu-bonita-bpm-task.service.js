...
var zgwnu_bonita_task_mapping_1 = require("./zgwnu-bonita-task-mapping");
var ZgwnuBonitaBpmTaskService = /** @class */ (function (_super) {
    ...
    function ZgwnuBonitaBpmTaskService(configService, http) {
        ...
        _this.taskResourceUrl = configService.apiUrl + _this.TASK_RESOURCE_PATH;
        return _this;
    }
    ZgwnuBonitaBpmTaskService.prototype.searchTasks = function (searchParms) {
        var taskMapping = new zgwnu_bonita_task_mapping_1.ZgwnuBonitaTaskMapping();
    ...
    ZgwnuBonitaBpmTaskService = __decorate([
        core_1.Injectable(),
...
exports.ZgwnuBonitaBpmTaskService = ZgwnuBonitaBpmTaskService;
