...
export { ZgwnuBonitaCreateCaseSuccessResponse, ZgwnuBonitaDeployProcessDefinitionSuccessResponse, ZgwnuBonitaProcessDefinition, ZgwnuBonitaProcessUpdateInput, ZgwnuBonitaProcessUpdateSuccessResponse } from './bpm/process';
export { ZgwnuBonitaCase } from './bpm/case';
export { ZgwnuBonitaDocument, ZgwnuBonitaDocumentCreateInput, ZgwnuBonitaDocumentUpdateInput } from './bpm/document';
...
export { ZgwnuBonitaBusinessDataContext, ZgwnuBonitaBusinessDataObject, ZgwnuBonitaBusinessDataQueryParms } from './bdm';
